...
CREATE TABLE user_profile_cache (
  ...
  school_level      TEXT CHECK (school_level IN ('초','중','고')),  -- 학교급
  grade             SMALLINT CHECK (grade BETWEEN 1 AND 6),         -- 학년 (학교급 내 순번)
...
COMMENT ON COLUMN user_profile_cache.grade        IS '학년 (1~6) — 초1~6, 중1~3, 고1~3. 표시는 school_level || grade';
...
--     payload: { member_no, login_id, name, school_level, grade, center, iat, exp }
